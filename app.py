...
def classify_by_color(image_path):
    ...
    if avg_brightness < 80:
        return "ขยะอินทรีย์ (เช่น เศษอาหาร)", "bins/organic.png"
    elif avg_brightness < 140:
        return "ขยะทั่วไป (เช่น ซองขนม)", "bins/general.png"
    elif avg_brightness < 200:
        return "ขยะรีไซเคิล (เช่น ขวดพลาสติก)", "bins/recycle.png"
    else:
        return "ขยะรีไซเคิล (เช่น ขวดแก้ว, โลหะ)", "bins/metal.png"
